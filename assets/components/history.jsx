...
export default class History extends Component {
    ...
    render() {
        return <article id="history" className="history__view view">
            <article className="container">
                <article className="row justify-content-center">
                    <section className="col-12 col-lg-11 col-xl-9">
...
export class ExperienceDetail extends Component {
    render() {
        ...
        switch (experience.type) {
            case 'formation':
                return <p>
                    <i>{experience.diplome}</i><br />
                    <small className="text-muted">{experience.label}</small>
                    <small className="history__date text-muted"><i>
                        {experience.start.getMonth().toString().padStart(2, '0')}/{experience.start.getFullYear().toString().padStart(2, '0')}
                        {' '}→{' '}
                        {experience.end.getMonth().toString().padStart(2, '0')}/{experience.end.getFullYear().toString().padStart(2, '0')}
                    </i></small>
                </p>
            case 'job':
                return <p>
                    <b>{experience.job}</b><br />
