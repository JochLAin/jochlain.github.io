    ...
    return <>
        ...
        <article className="container">
            ...
            <footer>
                ...
                <a href="@portfolio/assets/components/hero" target="_blank" rel="noreferrer noopener">
                    <FontAwesomeIcon icon={brands('linkedin')} size="2x" fixedWidth />
                </a>
            </footer>
        </article>
        <a href="@portfolio/assets/components/hero#about" className="navigation-hint-bottom">
